 ...
 */
package threaddds;
import Module3__Assessment.Threadss;
...
private Thread thread;
    private colors.Runs running = running = new colors.Runs();
    private Random rand = new Random();
    private int MaxColorHue = 245;
    /**
 ...
 public void Animation(){
    ...
    private void initComponents() {
        ...
        B.setFont(new java.awt.Font("Adobe Devanagari", 1, 36)); // NOI18N
        B.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        B.setText("BLESS");
        B.setOpaque(true);

        A.setBackground(new java.awt.Color(51, 51, 255));
        A.setFont(new java.awt.Font("Adobe Devanagari", 1, 36)); // NOI18N
        A.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        A.setText("ALWAYS");
        A.setOpaque(true);

        G.setBackground(new java.awt.Color(51, 51, 255));
        G.setFont(new java.awt.Font("Adobe Devanagari", 1, 36)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(G, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            if(thread.isAlive()){
                ...
                System.out.println("THREAD ALREADY STOPED!");
            }
        } catch (Exception ex) {
            System.out.println("THREAT IS NOT STARTED");
        }
